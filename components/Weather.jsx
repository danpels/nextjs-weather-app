...
const Weather = ({data}) => {
  ...
  return (
    <div className='relative flex-col justify-between max-w-[500px] w-full h-[90vh] m-auto p-4 text-white z-10'>
        ...
        <div className='bg-black/50 relative p-8 rounded-md mt-40'>
            ...
            <div className='flex justify-between text-center'>
                ...
                <div>
                    <p className='text-3xl'>{data.main.humidity.toFixed(0)}%</p>
